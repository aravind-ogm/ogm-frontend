    ...
    return (
        <div className="about-container">
            ...
            <div className="about-main-copy">
                <p>
                    One Global Marketplace is an End to End customer service and support solution where we help our
                    customers choose their home within their budget, proximity, amenities and whatever bengaluru offers.
                    Every step of the way, we ensure our customers are being addressed through thick and thin.

                    We are not typical real estate agents, we are a group of professional individuals building a
                    platform for customers to make the right choice. We will ensure you have all the information at your
                    fingertips but you take the call.
