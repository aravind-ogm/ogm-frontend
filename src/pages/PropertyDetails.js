...
export default function PropertyDetails() {
    ...
    const handleShare = async () => {
        const shareData = {
            title: property?.title, text: "Check out this property!", url: window.location.href
        };
    ...
    ----------------------------------------- */
    const galleryImages = property.images?.length > 0 ? property.images : property.mainImages?.length > 0 ? property.mainImages : [property.image];
    ...
    return (<div className="details-container">
        ...
        {/* BROCHURE MODAL */}
        {showBrochureModal && (<div className="modal-overlay">
            <div className="modal-content">
                ...
                <form onSubmit={handleBrochureSubmit}>
                    ...
                    {brochureStatus === "error" && (<p style={{color: "red", marginTop: "10px"}}>
                        Please check your details and try again.
                    </p>)}

                    {brochureStatus === "success" && (<p style={{color: "green", marginTop: "10px"}}>
